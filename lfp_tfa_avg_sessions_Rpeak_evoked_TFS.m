function sessions_avg = lfp_tfa_avg_sessions_Rpeak_evoked_TFS(lfp_tfr, lfp_tfa_cfg)
                                    ...
                                    if isfield(lfp_tfr.session(i).session_avg(k).condition(cn).hs_tuned_tfs(st, hs), 'powspctrm') ...
                                        ...
                                        if nsessions == 1
                                            ...
                                            if isfield(lfp_tfr.session(i).session_avg(k).condition(cn).hs_tuned_tfs(st, hs), 'state') ...
                                                && isfield(lfp_tfr.session(i).session_avg(k).condition(cn).hs_tuned_tfs(st, hs), 'state_name')
