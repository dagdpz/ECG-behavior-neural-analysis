function [ session_evoked ] = ecg_bna_compute_session_Rpeak_evoked_LFP_fast( session_proc_lfp, Rpeaks,analyse_states, ecg_bna_cfg )
...
for i = 1:nsites
    ...
    if isfield(ecg_bna_cfg, 'random_permute_triggers') && ecg_bna_cfg.random_permute_triggers
        ...
        shuffled_Rpeaks = ecg_bna_get_shuffled_Rpeak_fast(session_proc_lfp(i).trials, nshuffles); %% even better would be do it for entire sessoin and split afterwards
    end
            ...
            for st = 1:size(analyse_states, 1)
                ...
                if strcmp(analyse_states{st, 1}, 'ecg')
                    ...
                    if isfield(ecg_bna_cfg, 'random_permute_triggers') && ecg_bna_cfg.random_permute_triggers
                        ...
                        [cond_trials_lfp.ECG_spikes]=shuffled_Rpeaks{cond_trials};
