function condition_label = ecg_bna_get_condition_label(cfg_condition, label_length)
%ecg_bna_get_condition_label - Get a label for a given trial condition (A
...
% REQUIRES:	
%
% See also ecg_bna_compute_diff_condition_average, lfp_tfa_compare_conditions
%
