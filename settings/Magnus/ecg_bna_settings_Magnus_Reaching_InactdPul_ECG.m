...
%% Settings for data folders and analysis

% absolute path to the folder where the results of analysis should be stored
ecg_bna_cfg.results_folder = 'Y:\Personal\Sarath\Results\ECG_BNA_Results';
...
<<<<<<<< HEAD:settings/Magnus/ecg_bna_settings_Magnus_Reaching_InactdPul_ECG.m
...
ecg_bna_cfg.version = 'Magnus_Reach_InacDPul_ECG';
========
% the folder <lfp_tfa_cfg.results_folder>\<lfp_tfa_cfg.version>
% eg: 'Y:\Personal\Sarath\Results\ECG_BNA_Results\Magnus_dPul_ECG_LFP'
ecg_bna_cfg.version = 'Magnus_dPul_ECG_LFP';
>>>>>>>> UnderstandingAnalaysis_KK:settings/Magnus/ecg_bna_settings_Magnus_dPul_ECG_LFP.m
...
<<<<<<<< HEAD:settings/Magnus/ecg_bna_settings_Magnus_Reaching_InactdPul_ECG.m
           ...
           'Input_ECG_preproc',  {{'Y:\Projects\PhysiologicalRecording\ephys\ECG_rest\by_block_Magnus_20191213.mat', ...
           'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20191213.mat'}}); 
       
ecg_bna_cfg.session_info(3) = ...
    struct('Monkey',        'Magnus', ...
           'Date',          '20191211', ...
           'Input_ECG',         'Y:\Projects\PhysiologicalRecording\Data\Magnus\20191211\20191211_ecg.mat', ...
           'Input_ECG_preproc',  {{'Y:\Projects\PhysiologicalRecording\ephys\ECG_rest\by_block_Magnus_20191211.mat', ...
           'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20191211.mat'}}); 
       
ecg_bna_cfg.session_info(2) = ...
 struct('Monkey',        'Magnus', ...
           'Date',          '20191120', ...
           'Input_ECG',         'Y:\Projects\PhysiologicalRecording\Data\Magnus\20191120\20191120_ecg.mat', ...
           'Input_ECG_preproc',  {{'Y:\Projects\PhysiologicalRecording\ephys\ECG_rest\by_block_Magnus_20191120.mat', ...
           'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20191120.mat'}}); 
       
       ecg_bna_cfg.session_info(1) = ...
    struct('Monkey',        'Magnus', ...
           'Date',          '20191113', ...
           'Input_ECG',         'Y:\Projects\PhysiologicalRecording\Data\Magnus\20191113\20191113_ecg.mat', ...
           'Input_ECG_preproc',  {{'Y:\Projects\PhysiologicalRecording\ephys\ECG_rest\by_block_Magnus_20191113.mat', ...
           'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20191113.mat'}});  
% %        
========
           'Date',          '20190131', ...
...
ecg_bna_cfg.session_info(2) = ...
    struct('Monkey',        'Magnus', ...
           'Date',          '20190213', ...
           'Input_LFP',         {'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190213\sites_Magnus_20190213.mat'} ,...
...
%     struct('Monkey',        'Magnus', ...
%            'Date',          '20190404', ...
%            'Input_LFP',         {'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190404\sites_Magnus_20190404.mat'} ,...
%            'Input_ECG',         'Y:\Projects\PhysiologicalRecording\Data\Magnus\20190404\20190404_ecg.mat', ...
%            'Input_ECG_preproc', 'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20190404.mat', ...
%            'Preinj_blocks',  [1 2 4], ...
%            'Postinj_blocks', []); 
...
%     struct('Monkey',            'Magnus', ...
%            'Date',              '20191110', ...
%            'Input_ECG',         'Y:\Projects\PhysiologicalRecording\Data\Magnus\20191110\20191110_ecg.mat', ...
%            'Input_ECG_preproc', 'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20191110.mat', ...
%            'Preinj_blocks',     [1, 2, 3], ...
%            'Postinj_blocks',    []);
%        
%        
...
%     struct('Monkey',            'Magnus', ...
%            'Date',              '20191111', ...
%            'Input_ECG',         'Y:\Projects\PhysiologicalRecording\Data\Magnus\20191111\20191111_ecg.mat', ...
%            'Input_ECG_preproc', 'Y:\Projects\PhysiologicalRecording\ephys\ECG_reaching\by_block_Magnus_20191111.mat', ...
%            'Preinj_blocks',     [1, 2, 3, 4, 5], ...
%            'Postinj_blocks',    []);
...
%            'Preinj_blocks',     [1 3 5], ...
%            'Postinj_blocks',    []); 
%        'Input_LFP',         {{'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190213_rest\sites_Magnus_20190213.mat', ...
%                                 'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190213\sites_Magnus_20190213.mat'}}, ...
...
%            'Preinj_blocks',     [1 2 4], ...
%            'Postinj_blocks',    []); 
%        'Input_LFP',         {{'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190404_rest\sites_Magnus_20190404.mat', ...
%                                 'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190404\sites_Magnus_20190404.mat'}}, ...
...
========
ecg_bna_cfg.compare.effectors = [6];
>>>>>>>> UnderstandingAnalaysis_KK:settings/Magnus/ecg_bna_settings_Magnus_dPul_ECG_LFP.m
...
ecg_bna_cfg.compare.success = inf;
...
lfp_tfa_cfg.diff_condition(1) = {{'perturbation', {0, 1}}}; %pre vs post for each type of task
% lfp_tfa_cfg.diff_condition(2) = {{'choice', {0, 1}}};
<<<<<<<< HEAD:settings/Magnus/ecg_bna_settings_Magnus_Reaching_InactdPul_ECG.m
%ecg_bna_cfg.diff_condition(1) = {{'type_eff', {[2 1], [1 0]}}};%, 'perturbation', {0, 1}}};
%ecg_bna_cfg.diff_condition(1) = {{'perturbation', {0, 1} 'success', {0, 1}}};
...
ecg_bna_cfg.event_triggers = {lfp_tfa_states.REA_INI,   'Reach ini',    -0.5,   0.5;...
...
ecg_bna_cfg.analyse_Rpeak_states = {lfp_tfa_states.REA_INI,   'Reach ini', [-0.25 0.25], 'afterRpeak'; ...
...
% flag which indicates whether to read the LFP data from the processed file
% and recompute the LFP TFS, detection of noisy trials, and baseline
% If the LFP processing is already done, this flag can be set to false to
% reuse the results. In this case, one must specify the folder which
% contains the processed LFP results. Currently this can only be true,
% implementation of false case to be done
ecg_bna_cfg.process_LFP = false;

% folder which contains the LFP processing results for all sites of a
% session
ecg_bna_cfg.proc_lfp_folder = '';
if ~ecg_bna_cfg.process_LFP
    ecg_bna_cfg.proc_lfp_folder = ...
        'Y:\Personal\Sarath\Results\ECG_BNA_Results\Magnus_dPul_ECG_LFP\Processed LFP';
end
...
if length(ecg_bna_cfg.compare.types) == 1
    ...
    ecg_bna_cfg.baseline_use_type = ecg_bna_cfg.compare.types(1); 
end
...
if length(ecg_bna_cfg.compare.effectors) == 1
    ...
    ecg_bna_cfg.baseline_use_effector = []; 
end
...
ecg_bna_cfg.baseline_method = 'zscore';
