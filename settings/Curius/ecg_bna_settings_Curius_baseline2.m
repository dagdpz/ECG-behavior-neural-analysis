...
lfp_tfa_cfg.version = 'Curius_baseline2';
...
lfp_tfa_cfg.compare.targets = {'dPul_R'}; 
...
lfp_tfa_cfg.analyse_states = {'ecg', 'ECG peak', -0.5, 0.5};

%% Settings for event triggered ECG R2R interval
lfp_tfa_cfg.event_triggers = {lfp_tfa_states.SAC_INI,   'Sac ini',    -1,   1;...
...
lfp_tfa_cfg.analyse_Rpeak_states = {lfp_tfa_states.SAC_INI,   'Sacc Ini', [-0.5 0.5], 'afterRpeak'; ...
                                    lfp_tfa_states.REWARD,    'Reward', [-0.5 0.5], 'afterRpeak'; ...
                                    lfp_tfa_states.ITI,       'ITI', [-0.5 0.5], 'afterRpeak'};
...
lfp_tfa_cfg.baseline_method = 'none';
