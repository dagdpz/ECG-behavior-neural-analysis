...
lfp_tfa_cfg.version = 'Magnus_dPul_ECG_LFP';
...
%     struct('Monkey',        'Magnus', ...
%            'Date',          '20190213', ...
%            'Input',         'Y:\Projects\PPC_pulv_body_signals\ephys\dPul_control_20190213_rest\sites_Magnus_20190213.mat', ...
%            'Preinj_blocks',  [0 2 3], ...
%            'Postinj_blocks', []);  
...
%           time windows
lfp_tfa_cfg.analyses = {'Rpeak_evoked_ECG', 'Rpeak_evoked_onset', 'Event_trig_R2Rt', ...
    'Rpeak_evoked_LFP', 'Rpeak_evoked_TFS'}; % , 
...
%lfp_tfa_cfg.diff_legend{1} = {'Task', 'Rest'};
...
if length(lfp_tfa_cfg.compare.types) == 1
    ...
    lfp_tfa_cfg.baseline_use_type = inf; 
end
...
if length(lfp_tfa_cfg.compare.effectors) == 1
    ...
    lfp_tfa_cfg.baseline_use_effector = inf; 
end
...
lfp_tfa_cfg.random_permute_triggers = true;

% number of shuffles required
lfp_tfa_cfg.n_shuffles = 100;
...
lfp_tfa_cfg.event_triggers = {lfp_tfa_states.REA_INI,   'Reach ini',    -0.5,   0.5;...
...
lfp_tfa_cfg.normalize_R2Rt = true;
                          
lfp_tfa_cfg.analyse_Rpeak_states = {lfp_tfa_states.REA_INI,   'Reach ini', [-0.25 0.25], 'afterRpeak'; ...
