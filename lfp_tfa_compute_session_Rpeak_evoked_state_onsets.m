function [ session_evoked_ecg ] = lfp_tfa_compute_session_Rpeak_evoked_state_onsets( session_ecg, session_info, analyse_states, lfp_tfa_cfg ) 
        ...
        for cn = 1:length(site_conditions)
            ...
            for hs = 1:length(hs_labels)
                ...
                for st = 1:size(analyse_states, 1)                    
                    ...
                    Rpeak_states = lfp_tfa_get_Rpeak_evoked_state_onsets(...
