function session_ecg = ecg_bna_combine_shuffled_Rpeaks_extended(session_ecg, Rpeaks)
...
for nrblock=blocks
    block_Rpeak=Rpeaks(Rpeak_blocks==nrblock);
    ...
    ts = session_ecg.trials(trials_idx(1)).tsample*2;
