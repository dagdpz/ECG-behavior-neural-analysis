function [ session_R2Rt ] = lfp_tfa_compute_session_evoked_ECG_b2bt( session_ecg, session_info, analyse_states, lfp_tfa_cfg ) 
...
% lfp_tfa_compare_conditions, lfp_tfa_plot_evoked_lfp
    ...
    results_folder_ecg = fullfile(session_info.analyse_lfp_fldr, 'ECG_analysis');
