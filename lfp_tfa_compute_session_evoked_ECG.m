function [ session_evoked_ecg ] = lfp_tfa_compute_session_evoked_ECG( session_ecg, session_info, analyse_states, lfp_tfa_cfg ) 
                ...
                for st = 1:size(analyse_states, 1)                    
                    ...
                    if strcmp(analyse_states{st, 1}, 'ecg')
                        ...
                        if isfield(lfp_tfa_cfg, 'random_permute_triggers') && ...
                            ...
                            shuffled_Rpeak_evoked = lfp_tfa_shuffled_Rpeak_evoked_ECG(cond_trials_ecg,...
...
%                             analyse_states(st, :));    
        ...
        for diff = 1:size(lfp_tfa_cfg.diff_condition, 2)
            ...
            sites_evoked(i).difference = [sites_evoked(i).difference, ...
                lfp_tfa_compute_diff_condition_evoked(sites_evoked(i).condition, ...
                diff_condition, diff_color, diff_legend)];
        end
        % plot Difference TFR
