...
for i = 1:nsites
    ...
    if isfield(ecg_bna_cfg, 'random_permute_triggers') && ecg_bna_cfg.random_permute_triggers
        ...
        shuffled_Rpeaks = ecg_bna_get_shuffled_Rpeak(session_proc_lfp(i).trials, nshuffles);
    end
                ...
                if strcmp(analyse_states{st, 1}, 'ecg')
                    ...
                    if isfield(ecg_bna_cfg, 'random_permute_triggers') && ecg_bna_cfg.random_permute_triggers
                        for shuff=1:nshuffles
                            ...
                            [cond_trials_lfp.ECG_spikes]=cond_trials_shuffled.ECG_spikes;
                            shuffled_evoked(shuff) = ecg_bna_get_Rpeak_evoked_LFP(cond_trials_lfp, analyse_states(st, :));
                        end
